    ...
    <>
      ...
      <section className="mx-auto grid max-w-7xl gap-6 px-3 py-20 md:grid-cols-2 lg:px-6">
        <article className="rounded-xl bg-[#F2B13E] p-5 md:p-10">
          ...
          <h2 className="mt-3 text-3xl md:text-4xl font-extrabold tracking-[-0.06em] text-[#403F43]">보통의 하루</h2>
          <p className="mt-3 text-base md:text-lg leading-8 text-[#403F43]/85">
            AI 기반 루틴 지원으로 기상, 위생, 복약처럼 필요한 일상을 스스로 이어갈 수 있게 합니다.
          </p>
          <a
        ...
        <article className="rounded-xl bg-[#403F43] p-5 text-white md:p-10">
          ...
          <h2 className="mt-3 text-3xl md:text-4xl font-extrabold tracking-[-0.06em]">소비·자산보호 플랫폼</h2>
          <p className="mt-3 text-base md:text-lg leading-8 text-white/75">
